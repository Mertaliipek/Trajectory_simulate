...
public class DriveTrain extends SubsystemBase {
  ...
  private final PIDController m_leftPIDController = new PIDController(0.49, 0.50, 0);     //kP ,kI , kD
  private final PIDController m_rightPIDController = new PIDController(0.49, 0.50, 0);    //kP , kI , kD
 ...
 // Create the trajectory to follow in autonomous. It is best to initialize
  ...
  //  Trajectory m_trajectory =
    //    TrajectoryGenerator.generateTrajectory(
          /*new Pose2d(1.283417,0, Rotation2d.fromDegrees(0)),
          List.of(new Translation2d(1, 0.1)),
          new Pose2d(6, 0, Rotation2d.fromDegrees(0)),  // x de gideceği kısım, y de gideceği kısım
